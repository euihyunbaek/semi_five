...
-->
  ...
  <main>
    ...
    <div class="grid-item top-element">
      <a id="stay-register" href="./stay-register.html"><i class="fi fi-rr-home-location-alt"></i> 숙박업소등록</a>
    </div>
    <div class="grid-item top-element">
    ...
    <div class="grid-item">
      <a id="business-book-list" href="./business-book-list.html"><i class="fi fi-rr-list-check"></i> 예약요청관리</a>
    </div>
    <div class="grid-item">

    ...
    <form action="" method="post" id="register-form">
      <fieldset id="essential-info">
        ...
        <label for="id" id="id-label">
          ID: <input type="text" name="id" id="id" placeholder="ID 입력" required pattern="^[a-zA-z]([\w_\-#\.]{3,12})$">
        </label>
        <!-- 비밀번호 : 영문 대문자, 소문자, 숫자, 특수기호 각각 적어도 하나씩 포함 8-16자리. -->
        <label for="pwd" id="pwd-label">
          비밀번호: <input type="password" name="pwd" id="pwd" placeholder="영문대소문자 특수기호 포함 8-16자리" required pattern="^(?=.*[a-zA-Z])(?=.*[A-Z])(?=.*[!@#$%^*+=-])(?=.*[0-9]).{8,15}$">
        </label>
      </fieldset>
